...
function Footer() {
  return (
    <div className="grid grid-cols-1 mt-10 pb-5 border-t pt-5  px-[15px] sm:grid-cols-3 gap-5  md:px-[40px] lg:px-[60px]">
      <div className="flex justify-between items-center border-b pb-2 sm:border-b-0">
        <p>Omcar eng.</p>
        <div className="flex justify-end items-center gap-2">
          <div className="border rounded-full p-2 hover:border-[#0074de]">
